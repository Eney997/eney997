...
I'm currently deepening my understanding of low-level programming by learning **Assembly**, **C**, and **C++**. These languages are helping me build a strong foundation in how software interacts with hardware, memory management, and performance optimization.

At the same time, I'm deeply involved in Android development, mastering modern tools like **Kotlin** and **Jetpack Compose**. I’m focused on creating intuitive, responsive, and user-friendly mobile applications, and I constantly explore new libraries, design patterns, and best practices to bring great app ideas to life.
...
![Navigation](https://img.shields.io/badge/Navigation-2d2d2d?style=for-the-badge&logo=android&logoColor=white)
